...
| 42 | [use-cases/42-conversation-fold-injected-user-lines.md](use-cases/42-conversation-fold-injected-user-lines.md) | Conversation view — stop rendering harness-injected user lines (skill bodies, slash-command wrappers, isMeta) as the user's own right-aligned messages | in-progress | 2026-06-09 |
| 43 | [use-cases/43-conversation-multi-question-sheet.md](use-cases/43-conversation-multi-question-sheet.md) | Conversation view — multi-question AskUserQuestion halts and shows only one question (paged in-app sheet + live delivery) | pending | 2026-06-09 |
