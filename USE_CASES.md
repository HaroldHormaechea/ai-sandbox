...
| 41 | [use-cases/41-collapsible-tool-skill-bubbles-with-detail-popup.md](use-cases/41-collapsible-tool-skill-bubbles-with-detail-popup.md) | Collapse tool-use / skill bubbles to a one-line summary, tap to expand full command + output | in-progress | 2026-06-08 |
