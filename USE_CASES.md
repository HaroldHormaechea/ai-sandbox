...
| 54 | [use-cases/54-tri-state-connectivity-dot.md](use-cases/54-tri-state-connectivity-dot.md) | Tri-state server-connectivity dot on the Sessions screen (green/yellow/red); replace the UC-52 unreachable banner; no blocking screen for server-unavailable | in-progress | 2026-06-10 |
