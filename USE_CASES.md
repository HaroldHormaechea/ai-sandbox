...
| 56 | [use-cases/56-sessions-list-connection-error-loop.md](use-cases/56-sessions-list-connection-error-loop.md) | Connection-error loop when returning from a conversation to the sessions list (re-scan-QR/Quit screen re-pushed in a flicker loop; reachable server should land on a stable list) | in-progress | 2026-06-11 |
