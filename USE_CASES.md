...
| 37 | [use-cases/37-android-structured-conversation-mode.md](use-cases/37-android-structured-conversation-mode.md) | Android remote view — structured "conversation" connection mode over the live session (single-tap), tmux fallback (long-press) | pending | 2026-06-08 |
