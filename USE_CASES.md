...
| 38 | [use-cases/38-versioned-image-rebuild-on-upgrade.md](use-cases/38-versioned-image-rebuild-on-upgrade.md) | Versioned `ai-context` image with explicit and upgrade-triggered rebuild | pending | 2026-06-08 |
