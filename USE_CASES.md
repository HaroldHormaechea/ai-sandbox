...
| 45 | [use-cases/45-local-echo-user-messages.md](use-cases/45-local-echo-user-messages.md) | Echo user messages locally in the conversation view (optimistic, reconcile on server echo) | pending | 2026-06-09 |
| 46 | [use-cases/46-server-row-lifecycle-context-menu.md](use-cases/46-server-row-lifecycle-context-menu.md) | Server-row context menu with Docker-lifecycle actions (remove/stop/start/pause/unpause), keep slide-to-remove | pending | 2026-06-09 |
