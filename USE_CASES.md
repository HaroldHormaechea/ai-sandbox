...
| 42 | [use-cases/42-conversation-fold-injected-user-lines.md](use-cases/42-conversation-fold-injected-user-lines.md) | Conversation view — stop rendering harness-injected user lines (skill bodies, slash-command wrappers, isMeta) as the user's own right-aligned messages | pending | 2026-06-09 |
