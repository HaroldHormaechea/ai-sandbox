...
| 44 | [use-cases/44-conversation-multi-question-other-freetext-fix.md](use-cases/44-conversation-multi-question-other-freetext-fix.md) | Conversation view — multi-question "Other" free-text answers dropped (multiSelect) or break the wizard (non-last single-select) | in-progress | 2026-06-09 |
