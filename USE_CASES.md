...
| 37 | [use-cases/37-android-claude-question-sideband.md](use-cases/37-android-claude-question-sideband.md) | Android remote view — native rendering of Claude's questions (AskUserQuestion + plan-mode) via a transcript-tail sideband | pending | 2026-06-08 |
