...
| 53 | [use-cases/53-android-settings-appearance-prefs.md](use-cases/53-android-settings-appearance-prefs.md) | Android client — Settings screen with appearance preferences (current settings demoted to an "Info" subsection) | in-progress | 2026-06-10 |
...
| 55 | [use-cases/55-answer-pending-questions-in-app.md](use-cases/55-answer-pending-questions-in-app.md) | Answer pane-derived pending AskUserQuestion in-app (drop the "answer in tmux" fallback); verify answer-send path | pending | 2026-06-10 |
...
| 57 | [use-cases/57-inapp-answer-sends-wrong-option.md](use-cases/57-inapp-answer-sends-wrong-option.md) | In-app AskUserQuestion answer sends the wrong option (first-visible instead of selected); fix selection → answer-frame mapping for single/multi/Other | in-progress | 2026-06-11 |
