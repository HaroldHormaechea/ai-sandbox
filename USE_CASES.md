...
| 50 | [use-cases/50-conversation-pending-question-not-shown-transcript-blind.md](use-cases/50-conversation-pending-question-not-shown-transcript-blind.md) | Conversation view — pending AskUserQuestion (single AND multi) no longer shows while the session blocks (UC-40 regression on current Claude; deliver from the UC-49 tmux-pane signal) | pending | 2026-06-10 |
| 51 | [use-cases/51-sessions-list-crash-on-unreachable-server.md](use-cases/51-sessions-list-crash-on-unreachable-server.md) | App crashes when the server is unreachable — uncaught ConnectException in SessionsCoordinator.refresh()/spawn() (delete()/lifecycle() already guarded) | pending | 2026-06-10 |
| 52 | [use-cases/52-connection-drop-misclassified-as-tls-identity-error.md](use-cases/52-connection-drop-misclassified-as-tls-identity-error.md) | Transient connection drop misrouted to the destructive "re-scan a fresh invite QR" TLS-identity screen (no retry/auto-recovery); reclassify connectivity vs TLS | pending | 2026-06-10 |
