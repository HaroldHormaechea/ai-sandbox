...
| 44 | [use-cases/44-local-echo-user-messages.md](use-cases/44-local-echo-user-messages.md) | Echo user messages locally in the conversation view (optimistic, reconcile on server echo) | pending | 2026-06-09 |
| 45 | [use-cases/45-server-row-lifecycle-context-menu.md](use-cases/45-server-row-lifecycle-context-menu.md) | Server-row context menu with Docker-lifecycle actions (remove/stop/start/pause/unpause), keep slide-to-remove | pending | 2026-06-09 |
| 46 | [use-cases/46-server-row-conversation-name.md](use-cases/46-server-row-conversation-name.md) | Show the Claude conversation name in each server row's status section | pending | 2026-06-09 |
| 47 | [use-cases/47-server-row-working-spinner.md](use-cases/47-server-row-working-spinner.md) | Per-row working spinner to spot genuinely idle sessions at a glance | pending | 2026-06-09 |
