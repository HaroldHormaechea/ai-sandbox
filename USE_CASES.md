...
| 39 | [use-cases/39-chat-style-aligned-bubbles.md](use-cases/39-chat-style-aligned-bubbles.md) | Chat-style aligned message bubbles in the conversation view | pending | 2026-06-08 |
| 40 | [use-cases/40-conversation-question-not-delivered-until-tmux.md](use-cases/40-conversation-question-not-delivered-until-tmux.md) | Conversation view — AskUserQuestion (and preceding message) not delivered until you answer in tmux | pending | 2026-06-08 |
| 41 | [use-cases/41-collapsible-tool-skill-bubbles-with-detail-popup.md](use-cases/41-collapsible-tool-skill-bubbles-with-detail-popup.md) | Collapse tool-use / skill bubbles to a one-line summary, tap to expand full command + output | pending | 2026-06-08 |
